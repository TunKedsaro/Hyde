...
class HydeGenerator(GoogleCloudStorage,DataQuery):
    ...
    def sequential_of_single_student_generator(self):
        ...
        for i, student_id in enumerate(student_ids, start=1):
            ...
            print(f"\nProcessing {i}/{total_students} ({percent:.2f}%) -> {student_id}")
    ...
    # def single_hyde_generator3(self, 
    #             history_threshold, recent_k, feed_text_max_chars, include_recent_feeds, query_embedding_model_name,
    #             expected_dim,
    #             prompts,
    #             client,
    #             output_dim,
    ...
    # def sequential_of_single_student_generator3(self):
    #     t0_total  = time.perf_counter()
    #     report_each_student = []
    #     failed              = []
    #     slow                = []
    ...
    #         percent = (i / total_students) * 100
    #         print(f"\nProcessing {i}/{total_students} ({percent:.2f}%) -> {student_id}")
    #         result = self.single_hyde_generator3(
    #             student_id,
    #             history_threshold, recent_k, feed_text_max_chars, include_recent_feeds, query_embedding_model_name,
    #             expected_dim,
    #             prompts,
    ...
    #     return report
# hg = HydeGenerator(
#     bucket_name = "hyde-datalake-test",
#     verbose     = 0
# )
# student_payload = {
#   "student": {
...
#       "feed_id": "TH_F008",
#       "event_type": "click",
#       "ts": "2026-01-04T14:05:02Z",
#       "dwell_ms": 1200
#     }
#   ],
#   "feeds_lookup": {
#     "TH_F008": "Machine learning introduction"
#   }
# }
